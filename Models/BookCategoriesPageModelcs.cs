...
namespace Donea_Paul_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        
 public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Donea_Paul_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Donea_Paul_Lab8Context context,
